...
class VillagePlanningInstance(SimpleNamespace):
    """Pickle-friendly planning instance with the heuristic hook expected by base caches."""

    def compute_heuristics(self, *_, **__) -> None:
...
class VillageEnv:
    ...
    def build_record(
        ...
        instance_id = (
            f"mrmp-fastpathplanning-village3d-random-s{village_side}-d{density_id}"
        ...
        return {
            ...
            "base_instance_id": (
                f"base-fastpathplanning-village3d-s{village_side}-d{density_id}"
