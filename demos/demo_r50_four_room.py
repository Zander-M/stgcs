...
DEFAULT_MANIFEST_PATH = ROOT / "data/instances/mrmp/demo_r50_four_room/manifest.json"
DEFAULT_SOLUTION_OUTPUT = ROOT / "data/solutions/demo_r50_four_room/mrmp_solution.json"
DEFAULT_TRAJOPT_OUTPUT = ROOT / "data/solutions/demo_r50_four_room/trajopt_solution.json"
DEFAULT_HOST = "127.0.0.1"
DEFAULT_PORT = 8765

BASE_DOMAIN_KEY = "simple2d"
BASE_INSTANCE_ID = "base-simple2d-seed00000"
INSTANCE_ID = "mrmp-base-simple2d-seed00000-50-robot-random"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Solve and view the 50-robot SIMPLE2D large-scale MRMP demo."
    )
    ...
    if int(record.num_agents) != 50:
        raise ValueError(f"Expected the 50-agent large-scale record, got {record.num_agents}.")
