...
from experiments.base.heuristic_ablation_selection import (
...
class STHeuristicAblationManifestCLI:
    DEFAULT_OUTPUT = Path("data/st_planning/manifest.json")
    DEFAULT_RESULT_OUTPUT_ROOT = Path("data/st_planning/heuristic_ablation/results")
