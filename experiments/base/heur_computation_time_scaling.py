...
from experiments.base.build_manifest import BaseManifestBuilder, ManifestLock
from experiments.base.common import BaseInstanceFactory
from experiments.base.manifest import BaseBenchmarkRecord, load_manifest, save_manifest
from experiments.base.offline_heuristics import BaseOfflineHeuristicCLI, BaseOfflineHeuristicStore
...
class HeuristicComputationTimeScalingBuilder(BaseManifestBuilder):
    ...
    def cleanup_failed_candidate(manifest_path: Path, record: BaseBenchmarkRecord) -> None:
        BaseOfflineHeuristicStore.clear_runtimes(
            manifest_path,
            record.instance_id,
            {
