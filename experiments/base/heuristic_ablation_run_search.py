...
from experiments.mrmp.planner_defs import SEARCH_GROUPS, SearchPlannerSpec
...
class STHeuristicAblationRunCLI:
    ...
    def parse_args(cls) -> argparse.Namespace:
        ...
        parser.add_argument("--output-root", type=Path, default=Path("data/st_planning/heuristic_ablation/results"))
