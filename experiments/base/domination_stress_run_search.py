...
from experiments.base.domination_stress_manifest import STDominationStressManifestBuilder
...
class STDominationStressRunCLI:
    ...
    DEFAULT_OUTPUT_ROOT = Path("data/st_planning/stress_test/results")
