...
from experiments.st_runners.domination_stress_manifest import STDominationStressManifestBuilder
...
class STDominationStressRunCLI:
    DEFAULT_MANIFEST = STDominationStressManifestBuilder.DEFAULT_OUTPUT
    DEFAULT_OUTPUT_ROOT = Path("data/results/st_planning/stress_test")
    DEFAULT_BUDGET = 600.0
    STRESS_SPECS: tuple[SearchPlannerSpec, ...] = (
    ...
    def parse_args(cls) -> argparse.Namespace:
        parser = argparse.ArgumentParser(
            description="Run the IPC-vs-ISC BFS domination stress test on the ST stress-test manifest."
        )
