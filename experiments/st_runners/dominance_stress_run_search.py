...
class STDominanceStressRunCLI:
    ...
    def parse_args(cls) -> argparse.Namespace:
        parser = argparse.ArgumentParser(
            description="Run the delta_pos-vs-delta_state BFS dominance stress test on the ST stress-test manifest."
        )
