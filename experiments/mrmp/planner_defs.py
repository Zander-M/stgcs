...
class PBSExpansionAblation:
    ...
    DEFAULT_OUTPUT_ROOT = "data/mrmp/pbs_node_expansion"
...
class WindowedCoordinationAblation:
    ...
    DEFAULT_OUTPUT_ROOT = "data/mrmp/windowed_coordination"
    DEFAULT_MANIFEST_ROOT = DEFAULT_OUTPUT_ROOT
...
class MRMPPerformanceComparison:
    LOW_LEVEL_SPEC = SearchPlannerSpec("Max", ("GUB", "IPC"), epsilon=10.0)
    DEFAULT_OUTPUT_ROOT = "data/mrmp/performance_comparison"
    DEFAULT_MANIFEST_ROOT = DEFAULT_OUTPUT_ROOT
    DOMAINS: Tuple[str, ...] = ("grid2d", "maze", "iris-2d")
    FAMILY = "intersection"
    MIN_NUM_AGENTS = 2
